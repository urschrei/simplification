...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "include_dirs": [
            "./simplification",
            "simplification",
            "/Users/sth/dev/simplification/venv/lib/python3.7/site-packages/numpy/core/include"
        ],
        "language": "c",
        "libraries": [
            "rdp"
 ...
 */
  ...
  if (unlikely(!__pyx_t_5 || !__pyx_t_7 || !PyBytes_AsString(__pyx_t_5))) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_GOTREF(__pyx_t_7);
